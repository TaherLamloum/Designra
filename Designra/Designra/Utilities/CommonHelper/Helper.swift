...
public var iPhoneXFactor: CGFloat { get {return ((screenWidth * 1.00) / 390.0)} }
...
public func displayMessage(message: String, messageError: Bool) {
    ...
    view.bodyLabel?.font = UIFont(name: Fonts.regular.rawValue.localized, size: Size.size_13.xFactor)
    view.titleLabel?.font = UIFont(name: Fonts.regular.rawValue.localized, size: Size.size_13.xFactor)
